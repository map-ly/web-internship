        ...
        <tr>
            <td colspan="4">
                ...
                <?php	
                    ...
                    $a = $conn->query($countSql);
                    
                    $totalPage = $a->num_rows;
                    $lastPage = ceil($totalPage/$limit);
                    $pageNo = 1;
                    for($i=0; $i < $lastPage; $i++) {
                        $incPage = $pageNo++;
                ?>
                    <a href="<?php echo $index;?>?page=<?php echo $incPage; ?>"><?php echo $incPage; ?></a>
                <?php
                    }
                ?>
                <a href="<?php echo $index;?>?page=<?php echo $next; ?>">Next</a>
            </td>
        </tr>
    </tfoot>
</table>
